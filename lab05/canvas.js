...
function desenhar_circulo_2(x, y, raio, inicio, fim, color_stroke, color_fill){
    ctx2.beginPath();
    ctx2.lineWidth = 2;
    ctx2.strokeStyle = color_stroke;
    ctx2.fillStyle = color_fill;
...
desenhar_quadrado_2(110, 150, 80, 75, 'brown')
desenhar_triangulo(110, 150, 190, 150, 150, 110, 'salmon')
desenhar_quadrado_2(120, 165, 25, 25, 'royalblue')
desenhar_quadrado_2(120, 165, 25, 25, 'royalblue')